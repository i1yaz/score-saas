...
listenChange = function (selector, callback) {
...
listenClick("#addItem", function () {
    ...
    $(".productId").select2({
        placeholder: Lang.get(
            "messages.flash.select_product_or_enter_free_text"
        ),
        tags: true,
    });
...
function ToggleBtnLoader(btnLoader) {
    ...
    var spinner = "<span class='spinner-border spinner-border-sm'></span> Processing...";
