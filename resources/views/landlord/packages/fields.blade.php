...
<div class="form-group col-sm-6">
    ...
    <div class="input-group mb-3">
        ...
        {{ Form::number('price_monthly', $package->amount_monthly??null, ['class' => 'form-control price-input price ','id'=>'price_monthly' , 'oninput' => "validity.valid||(value=value.replace(/[e\+]/gi,''))", 'min' => '-1', 'value' => '0', 'step' => '.01', 'pattern' => "^-?\d*(\.\d{0,2})?$", 'required', 'onKeyPress' => 'if(this.value.length==15) return false;'])}}
    </div>
</div>
<!-- Price Yearly-->
<div class="form-group col-sm-6">
    ...
    <div class="input-group mb-3">
        ...
        {{ Form::number('price_yearly', $package->amount_yearly??null,  ['class' => 'form-control price-input price ','id'=>'price_yearly' , 'oninput' => "validity.valid||(value=value.replace(/[e\+]/gi,''))", 'min' => '-1', 'value' => '0', 'step' => '.01', 'pattern' => "^-?\d*(\.\d{0,2})?$", 'required', 'onKeyPress' => 'if(this.value.length==15) return false;'])}}
