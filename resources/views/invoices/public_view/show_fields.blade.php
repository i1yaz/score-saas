                                    ...
                                    <div class="col-12 table-responsive">
                                        <table class="table table-striped box-shadow-none mt-4">
                                            ...
                                            @foreach ($invoice->invoiceItems as $index => $invoiceItem)
                                                <tr>
                                                    <td class="py-4">
                                                        {{ isset($invoiceItem->product->name) ? $invoiceItem->product->name : $invoiceItem->product_name ?? 'N/A' }}
                                                    </td>
                                                    <td class="py-4">
                                                        {{ number_format($invoiceItem->quantity, 2) }}</td>
                                            ...
                                            <table class="table table-borderless box-shadow-none mb-0 mt-5">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-gray-900 text-end pe-0">
                                                        {{ isset($invoice->amount) ? getInvoiceCurrencyAmount($invoice->amount, $invoice->currency_id, true) : 'N/A' }}
                                                    </td>
                                                </tr>
                                                <tr>
                                ...
                                <div
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xxl-12 col-lg-4 col-sm-6 d-flex flex-column mb-xxl-7">
                                            ...
                                            <span
                                                class="fs-4 text-gray-900">{{ getInvoiceCurrencyAmount(getInvoicePaidAmount($invoice->id), $invoice->currency_id, true) }}</span>
                                        </div>
                                        <div class="col-xxl-12 col-lg-4 col-sm-6 d-flex flex-column mb-xxl-7">
                                            <label for="name"
                                                   class="pb-2 fs-4 text-gray-600">{{ __('messages.invoice.remaining_amount') }}</label>
                                            <span
                                                class="fs-4 text-gray-900">{{ getInvoiceCurrencyAmount(getInvoiceDueAmount($invoice->id), $invoice->currency_id, true) }}
                                            </span>
                                        </div>
                                        @if ($invoice->recurring_status == 1)
                                            <div class="col-xxl-12 col-lg-4 col-sm-6 d-flex flex-column mb-xxl-7">
                                                ...
                                                <span
                                                    class="fs-4 text-gray-900">{{ $invoice->last_recurring_on ? \Carbon\Carbon::parse($invoice->last_recurring_on)->translatedFormat(currentDateFormat()) : 'N/A' }}</span>
                                            </div>
                                            <div class="col-xxl-12 col-lg-4 col-sm-6 d-flex flex-column mb-xxl-7">
                                                <label for="name"
