...
<div class='btn-group float-right'>
    @if($invoice->invoiceable_type===\App\Models\StudentTutoringPackage::class && $invoice->has_installments==false)
        ...
        <a href="#" data-toggle="modal" data-target="#create-installments-{{$invoice->invoice_id}}" class='btn btn-default'>
            <i class="fa fa-bars" aria-hidden="true"></i>
            Installments
        </a>

        <div class="modal fade" id="create-installments-{{$invoice->invoice_id}}" style="display: none;" aria-hidden="true">
