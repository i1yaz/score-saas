...
<button type="button" class="btn waves-effect waves-light btn-block btn-danger button-loading-annimation"
        id="payment_button_stripe" disabled data-stripe-public-key="{{ $payload['stripe_public_key'] }}"
...
<!--STRIPE-->
<script src="{{asset('js/landlord/dynamic/stripe/checkout.stripe.js')}}?v={{ config('system.versioning') }}"></script>
