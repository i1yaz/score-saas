<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{asset('themes/frontend/assets/css/bootstrap.min.css?v=')}}{{$version}}">

    <!-- Fontawesome CSS -->
    <link rel="stylesheet" href="{{asset('themes/frontend/assets/css/fontawesome.all.min.css?v=')}}{{$version}}">

    <!-- Mobile Menu CSS -->
    <link rel="stylesheet" href="{{asset('themes/frontend/assets/plugins/meanmenu/meanmenu.min.css?v=')}}{{$version}}">


    <!-- Main css -->
    <link rel="stylesheet" href="{{asset('themes/frontend/assets/css/style.css?v=')}}{{$version}}">

    <!-- Vendor css -->
    <link rel="stylesheet" href="{{asset('themes/frontend/assets/css/vendor.css?v=')}}{{$version}}">

    <!-- Simple Line icons -->
    <link rel="stylesheet" href="{{asset('themes/frontend/assets/fonts/simplelineicons/css/simple-line-icons.css?v=')}}{{$version}}">


    <!-- Simple Line icons -->
    <link rel="stylesheet"
        href="{{asset('themes/frontend/assets/fonts/material-design-iconic-font/material-design-icons.css?v=')}}{{$version}}">

    <!-- jQuery JS -->
    <script src="{{asset('themes/frontend/assets/js/jquery.min.js?v=')}}{{$version}}"></script>
    ...
    <link rel="icon" type="image/png" sizes="16x16"
        href="logos/app/{{ config('system.settings_favicon_frontend_filename') }}{{$version}}">
