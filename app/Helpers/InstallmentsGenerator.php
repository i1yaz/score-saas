...
class InstallmentsGenerator
{
    ...
    {
        return $this->maxInstallments = $value;
    }
    ...
    {
        return $this->minInstallmentValue = $value;
    }
    ...
    {
        return $this->maxInstallmentsWithoutTax = $value;
    }
    ...
    public function get()
    {
        ...
        for ($i = 1; $i <= count($this->getTaxes()); $i++) {
            ...
            if ($installmentValue >= $this->getMinInstallmentValue() || $installment == 1) {
                ...
                $taxText = $this->getTaxes()[$key]['tax'] == 0 ? 'interest-free' : 'with interest';
